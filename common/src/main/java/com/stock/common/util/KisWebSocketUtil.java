...
public final class KisWebSocketUtil {
    ...
    /**
     * 환경에 따른 웹소켓 URL을 반환합니다.
     * 
     * @param kisApiProperties API 설정
     * @return 웹소켓 URL
     */
    public static String getWebSocketUrl(KisApiProperties kisApiProperties) {
        if (kisApiProperties.isRealEnvironment()) {
